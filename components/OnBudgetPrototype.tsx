                      ...
                      <CardContent className="p-4 space-y-3">
                        ...
                        <div className="space-y-2">
                          {travelAdvice.modeRanking.map((m, idx) => (
                            <div key={m.mode} className={`flex items-center justify_between border rounded-xl px-3 py-2 ${idx === 0 ? "border-emerald-400 bg-emerald-50" : "border-slate-200"}`}>
                              <div>
                    ...
                    <Card className="rounded-2xl shadow-sm">
                      <CardContent className="p-4 space-y-2">
                        ...
                        <div className="text-sm grid grid-cols-2 gap-1">
                          ...
                          <div>Pickup fuel est</div><div className="text-right">{formatUSD(travelAdvice.pickupFuel)}</div>
                          <div>Delivery fees est</div><div className="text-right">{formatUSD(travelAdvice.deliveryFees)}</div>
                        </div>
                        <div className="text-sm grid grid-cols-2 gap-1 pt-2 border-t">
                          <div className="font-medium">Pickup total</div><div className="text-right font-semibold">{formatUSD(travelAdvice.pickupTotal)}</div>
                          <div className="font-medium">Delivery total</div><div className="text-right font-semibold">{formatUSD(travelAdvice.deliveryTotal)}</div>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
